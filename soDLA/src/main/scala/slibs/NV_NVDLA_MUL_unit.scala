...
@chiselName
class NV_soDLA_MUL_unit(pINA_BW: Int, pINB_BW: Int) extends Module {
...
object NV_soDLA_MUL_unitDriver extends App {
    chisel3.Driver.execute(args, () => new NV_soDLA_MUL_unit(9, 16))
}
