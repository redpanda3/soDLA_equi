...
@chiselName
class NV_soDLA_HLS_shiftrightusz(IN_WIDTH:Int, OUT_WIDTH:Int, FRAC_WIDTH:Int, SHIFT_WIDTH:Int) extends Module {
...
object NV_soDLA_HLS_shiftrightuszDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_HLS_shiftrightusz(49, 32, 35, 6))
}
