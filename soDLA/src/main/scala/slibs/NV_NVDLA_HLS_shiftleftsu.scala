...
@chiselName
class NV_soDLA_HLS_shiftleftsu(IN_WIDTH:Int, OUT_WIDTH:Int, SHIFT_WIDTH:Int) extends Module {
...
object NV_soDLA_HLS_shiftleftsuDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_HLS_shiftleftsu(16, 32, 6))
}
