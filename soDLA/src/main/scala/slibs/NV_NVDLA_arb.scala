...
@chiselName
class NV_soDLA_arb(n:Int, wt_width:Int, io_gnt_busy:Boolean) extends Module {
...
object read_ig_arb_1Driver extends App {
    chisel3.Driver.execute(args, () => new NV_soDLA_arb(10, 8, true))
}


object read_eg_arb_1Driver extends App {
    chisel3.Driver.execute(args, () => new NV_soDLA_arb(10, 8, false))
}