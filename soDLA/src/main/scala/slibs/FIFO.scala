...
@chiselName
class NV_soDLA_fifo(depth: Int, width: Int,
                    ram_type: Int = 0, 
...
object NV_soDLA_fifoDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_fifo(depth = 20, width = 80, distant_wr_req = true, ram_type = 2))
}
