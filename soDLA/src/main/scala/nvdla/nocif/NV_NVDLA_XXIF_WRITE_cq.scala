...
@chiselName
class NV_soDLA_XXIF_WRITE_cq(vec_num: Int, width: Int)(implicit conf:nvdlaConfig) extends Module {
...
withClock(io.clk){
 ...
 object NV_soDLA_XXIF_WRITE_cqDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_XXIF_WRITE_cq(5, 3))
}
