...
@chiselName
class NV_soDLA_NOCIF_DRAM_READ_IG_bpt(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    /////////////////// pipe1 /////////////////////
    val pipe_p1 = Module(new NV_soDLA_IS_pipe(conf.NVDLA_DMA_RD_REQ))
    ...
    val pipe_p2 = Module(new NV_soDLA_IS_pipe(conf.NVDLA_DMA_RD_REQ))
...
object NV_soDLA_NOCIF_DRAM_READ_IG_bptDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_NOCIF_DRAM_READ_IG_bpt())
}
