...
@chiselName
class NV_soDLA_mcif(implicit conf: nvdlaConfig) extends Module {
...
withClockAndReset(io.nvdla_core_clk, !io.nvdla_core_rstn){
    val u_csb = Module(new NV_soDLA_MCIF_csb)
    val u_read = Module(new NV_soDLA_MCIF_read)
    val u_write = Module(new NV_soDLA_MCIF_write)
    //===========================================
    // NV_soDLA_MCIF_csb
    //===========================================
...
object NV_soDLA_mcifDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_mcif())
}
