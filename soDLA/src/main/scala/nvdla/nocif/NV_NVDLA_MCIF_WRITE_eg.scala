...
@chiselName
class NV_soDLA_MCIF_WRITE_eg(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_pipe = Module(new NV_soDLA_IS_pipe(3))
 ...
 object NV_soDLA_MCIF_WRITE_egDriver extends App {
     implicit val conf: nvdlaConfig = new nvdlaConfig
     chisel3.Driver.execute(args, () => new NV_soDLA_MCIF_WRITE_eg())
 }
