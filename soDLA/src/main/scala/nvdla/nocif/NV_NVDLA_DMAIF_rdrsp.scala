...
@chiselName
class NV_soDLA_DMAIF_rdrsp(DMABW: Int)(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    // pipe before mux
    ///////////////////////////////////////
    val is_pipe0 = Module{new NV_soDLA_IS_pipe(DMABW)}
    ...
    if(conf.NVDLA_SECONDARY_MEMIF_ENABLE){
        val is_pipe1 = Module{new NV_soDLA_IS_pipe(DMABW)}
    ...
    // pipe after mux
    ///////////////////////////////////////
    val is_pipe2 = Module{new NV_soDLA_IS_pipe(DMABW)}
