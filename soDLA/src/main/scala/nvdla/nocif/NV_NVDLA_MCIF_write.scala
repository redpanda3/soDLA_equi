...
@chiselName
class NV_soDLA_MCIF_write(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    val u_ig = Module(new NV_soDLA_MCIF_WRITE_ig)
    val u_cq = Module(new NV_soDLA_XXIF_WRITE_cq(vec_num = conf.MCIF_WRITE_CQ_VEC_NUM, width = conf.MCIF_WRITE_CQ_WIDTH))
    val u_eg = Module(new NV_soDLA_MCIF_WRITE_eg)
    //===========================================
    // NV_soDLA_MCIF_WRITE_ig
    //===========================================
...
object NV_soDLA_MCIF_writeDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_MCIF_write())
}
