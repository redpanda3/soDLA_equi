...
@chiselName
class NV_soDLA_XXIF_READ_IG_cvt(cq_enabled: Boolean)(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module(new NV_soDLA_IS_pipe(conf.NVDLA_MEM_ADDRESS_WIDTH+6))
...
object NV_soDLA_XXIF_READ_IG_cvtDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_XXIF_READ_IG_cvt(true))
}
