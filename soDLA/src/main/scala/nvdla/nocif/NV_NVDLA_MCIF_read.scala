...
@chiselName
class NV_soDLA_MCIF_read(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    val u_ig = Module(new NV_soDLA_MCIF_READ_ig)
    val u_eg = Module(new NV_soDLA_MCIF_READ_eg)
    //===========================================
    // NV_soDLA_MCIF_READ_ig
    //===========================================
...
object NV_soDLA_MCIF_readDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_MCIF_read())
}