...
@chiselName
class NV_soDLA_MCIF_WRITE_ig(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    val u_bpt = Array.fill(conf.WDMA_NUM){Module(new NV_soDLA_MCIF_WRITE_IG_bpt)}
    val u_arb = Module(new NV_soDLA_MCIF_WRITE_IG_arb)
    val u_cvt = Module(new NV_soDLA_MCIF_WRITE_IG_cvt)
    //===========================================
    // NV_soDLA_MCIF_WRITE_IG_bpt
    //===========================================
...
object NV_soDLA_MCIF_WRITE_igDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_MCIF_WRITE_ig)
}