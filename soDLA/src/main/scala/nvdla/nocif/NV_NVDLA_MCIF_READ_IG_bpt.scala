...
@chiselName
class NV_soDLA_MCIF_READ_IG_bpt(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_MCIF_READ_IG_bptDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_MCIF_READ_IG_bpt())
}
