...
@chiselName
class NV_soDLA_SDP_HLS_Y_int_alu extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val y_alu_sync2data = Module{new NV_soDLA_HLS_sync2data(32, 32)}
    ...
    val y_alu_saturate = Module{new NV_soDLA_HLS_saturate(32+1, 32)}
...
object NV_soDLA_SDP_HLS_Y_int_aluDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_Y_int_alu)
}