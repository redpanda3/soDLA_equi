...
@chiselName
class NV_soDLA_SDP_HLS_C_int extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module{new NV_soDLA_BC_pipe(33)}
    ...
    val pipe_p2 = Module{new NV_soDLA_BC_pipe(49)}
    ...
    //truncate
    val c_shiftrightsat_su = Module{new NV_soDLA_HLS_shiftrightsatsu(49, 17, 6)}
    ...
    val pipe_p3 = Module{new NV_soDLA_BC_pipe(18)}
    ...
    val c_saturate_int16 = Module{new NV_soDLA_HLS_saturate(17, 16)}
    c_saturate_int16.io.data_in := tru_out
    val dout_int16_sat = c_saturate_int16.io.data_out

    val c_saturate_int8 = Module{new NV_soDLA_HLS_saturate(17, 8)}
    ...
    val pipe_p4 = Module{new NV_soDLA_BC_pipe(17)}
...
object NV_soDLA_SDP_HLS_C_intDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_C_int)
}