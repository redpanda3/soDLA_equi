...
@chiselName
class NV_soDLA_SDP_RDMA_pack(IW: Int = 512, OW: Int = 256, CW: Int = 1)(implicit val conf: nvdlaConfig) extends Module {
   val RATIO = IW/OW
...
object NV_soDLA_SDP_RDMA_packDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_RDMA_pack())
}
