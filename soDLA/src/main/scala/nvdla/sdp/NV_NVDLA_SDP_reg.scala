...
@chiselName
class NV_soDLA_SDP_reg extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_single_reg = Module(new NV_soDLA_SDP_REG_single)
    ...
    val u_dual_reg_d0 = Module(new NV_soDLA_SDP_REG_dual)
    ...
    val u_dual_reg_d1 = Module(new NV_soDLA_SDP_REG_dual)
    ...
    //                                                                    //
    ////////////////////////////////////////////////////////////////////////
     val csb_logic = Module(new NV_soDLA_CSB_LOGIC(io_reg_rd_en = true))
...
object NV_soDLA_SDP_regDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_reg())
}