...
@chiselName
class NV_soDLA_SDP_RDMA_unpack(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_SDP_RDMA_unpackDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_RDMA_unpack())
}