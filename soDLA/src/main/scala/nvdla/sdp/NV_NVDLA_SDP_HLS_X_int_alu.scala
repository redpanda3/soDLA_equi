...
@chiselName
class NV_soDLA_SDP_HLS_X_int_alu extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val x_alu_sync2data = Module{new NV_soDLA_HLS_sync2data(16, 32)}
    ...
    val x_alu_shiftleft_su = Module{new NV_soDLA_HLS_shiftleftsu(16, 32, 6)}
    ...
    val pipe_p1 = Module{new NV_soDLA_BC_pipe(64)}
...
object NV_soDLA_SDP_HLS_X_int_aluDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_X_int_alu)
}
