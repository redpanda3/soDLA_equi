...
@chiselName
class NV_soDLA_SDP_WDMA_intr(implicit val conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    // Interrupt
    //==============
    val u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo = Module(new NV_soDLA_fifo(depth = 0, width = 1))
    u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.clk := io.nvdla_core_clk
    u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.wr_pvld := io.intr_req_ptr.valid & !cfg_mode_quite
    u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.wr_pd := io.intr_req_ptr.valid
    val intr_fifo_rd_pvld = u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.rd_pvld
    u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.rd_prdy := io.dma_wr_rsp_complete
    val intr_fifo_rd_pd = u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.rd_pd
    u_NV_soDLA_SDP_WDMA_DAT_DMAIF_intr_fifo.io.pwrbus_ram_pd := io.pwrbus_ram_pd
...
object NV_soDLA_SDP_WDMA_intrDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_WDMA_intr())
}
