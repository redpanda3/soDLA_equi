...
@chiselName
class NV_soDLA_SDP_RDMA_REG_dual extends Module{
...
object NV_soDLA_SDP_RDMA_REG_dualDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_RDMA_REG_dual())
}