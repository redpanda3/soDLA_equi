...
@chiselName
class NV_soDLA_SDP_MRDMA_ig(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_SDP_MRDMA_igDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_MRDMA_ig)
}
