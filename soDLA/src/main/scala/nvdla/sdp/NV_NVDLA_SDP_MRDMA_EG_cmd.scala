...
@chiselName
class NV_soDLA_SDP_MRDMA_EG_cmd extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_sfifo = Module{new NV_soDLA_fifo(depth = 4, width = 13, ram_type = 0, distant_wr_req = false)}
    ...
    val u_dfifo = Module{new NV_soDLA_fifo(depth = 4, width = 15, ram_type = 0, distant_wr_req = false)}
...
object NV_soDLA_SDP_MRDMA_EG_cmdDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_MRDMA_EG_cmd)
}