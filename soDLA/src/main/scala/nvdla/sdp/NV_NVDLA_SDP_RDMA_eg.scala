...
@chiselName
class NV_soDLA_SDP_RDMA_eg(implicit val conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_alu = Module(new NV_soDLA_SDP_RDMA_EG_ro)
    ...
    val u_mul = Module(new NV_soDLA_SDP_RDMA_EG_ro)
...
object NV_soDLA_SDP_RDMA_egDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_SDP_RDMA_eg())
}
