...
@chiselName
class NV_soDLA_SDP_HLS_Y_int_cvt extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    //truncate
    val y_mul_shiftright_su = Module{new NV_soDLA_HLS_shiftrightsu(33 + 16, 32, 6)}
...
object NV_soDLA_SDP_HLS_Y_int_cvtDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_Y_int_cvt)
}