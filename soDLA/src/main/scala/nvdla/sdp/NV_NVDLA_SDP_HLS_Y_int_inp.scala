...
@chiselName
class NV_soDLA_SDP_HLS_Y_int_inp extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module{new NV_soDLA_BC_pipe(71)}
    ...
    val pipe_p2 = Module{new NV_soDLA_BC_pipe(71)}
    ...
    val intp_flow_shiftright_ss = Module{new NV_soDLA_HLS_shiftrightss(IN_WIDTH = 32+16+2, OUT_WIDTH = 32, SHIFT_WIDTH = 5)}
    ...
    val pipe_p3 = Module{new NV_soDLA_BC_pipe(33)}
    ...
    val intp_flow_saturate = Module{new NV_soDLA_HLS_saturate(IN_WIDTH = 32+1, OUT_WIDTH = 32)}
    ...
    val pipe_p4 = Module{new NV_soDLA_BC_pipe(53)}
    ...
    val pipe_p5 = Module{new NV_soDLA_BC_pipe(53)}
    ...
    val pipe_p6 = Module{new NV_soDLA_BC_pipe(53)}
    ...
    val inp_shiftright_su = Module{new NV_soDLA_HLS_shiftrightsu(IN_WIDTH = 35+16+2, OUT_WIDTH = 32, SHIFT_WIDTH = 6)}
    ...
    val pipe_p7 = Module{new NV_soDLA_BC_pipe(32)}
    ...
    val pipe_p8 = Module{new NV_soDLA_BC_pipe(1)}
    ...
    val pipe_p9 = Module{new NV_soDLA_BC_pipe(1)}
    ...
    val pipe_p10 = Module{new NV_soDLA_BC_pipe(1)}
...
object NV_soDLA_SDP_HLS_Y_int_inpDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_Y_int_inp)
}
