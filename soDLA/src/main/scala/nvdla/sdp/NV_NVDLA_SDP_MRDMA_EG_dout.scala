...
@chiselName
class NV_soDLA_SDP_MRDMA_EG_dout(implicit val conf: nvdlaConfig) extends Module{
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module{new NV_soDLA_IS_pipe(conf.DP_DIN_DW+2)}
...
object NV_soDLA_SDP_MRDMA_EG_doutDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_SDP_MRDMA_EG_dout())
}