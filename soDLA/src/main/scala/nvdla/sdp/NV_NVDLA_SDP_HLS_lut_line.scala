...
@chiselName
class NV_soDLA_SDP_HLS_lut_line(LUT_DEPTH:Int = 256) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module(new NV_soDLA_BC_pipe(72))
    ...
    val pipe_p2 = Module(new NV_soDLA_BC_pipe(33))
    ...
    val lut_index_shiftright_usz = Module(new NV_soDLA_HLS_shiftrightusz(32, 9, 35, 8))
    ...
    val pipe_p3 = Module(new NV_soDLA_BC_pipe(46))
...
object NV_soDLA_SDP_HLS_lut_lineDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_lut_line())
}