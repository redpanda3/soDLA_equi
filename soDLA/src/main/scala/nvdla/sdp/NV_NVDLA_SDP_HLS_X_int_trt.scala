...
@chiselName
class NV_soDLA_SDP_HLS_X_int_trt extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val x_trt_shiftright_su = Module(new NV_soDLA_HLS_shiftrightsu(49, 32, 6))
...
object NV_soDLA_SDP_HLS_X_int_trtDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_X_int_trt)
}