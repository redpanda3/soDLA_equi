...
@chiselName
class NV_soDLA_SDP_HLS_X_int_mul extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val x_mul_sync2data = Module{new NV_soDLA_HLS_sync2data(16, 33)}
    ...
    val x_mul_prelu = Module{new NV_soDLA_HLS_prelu(33, 49, 16)}
...
object NV_soDLA_SDP_HLS_X_int_mulDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_X_int_mul)
}
