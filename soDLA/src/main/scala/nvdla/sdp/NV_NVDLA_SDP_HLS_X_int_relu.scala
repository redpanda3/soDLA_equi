...
@chiselName
class NV_soDLA_SDP_HLS_X_int_relu extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_x_relu = Module(new NV_soDLA_HLS_relu(32))
...
object NV_soDLA_SDP_HLS_X_int_reluDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_X_int_relu)
}