...
@chiselName
class NV_soDLA_SDP_HLS_Y_int_mul extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val y_mul_sync2data = Module{new NV_soDLA_HLS_sync2data(32, 32)}
    ...
    val x_mul_prelu = Module{new NV_soDLA_HLS_prelu(32, 32+32, 32)}
    ...
    val pipe_p1 = Module{new NV_soDLA_BC_pipe(96)}
    ...
    val y_mul_shiftright_su = Module{new NV_soDLA_HLS_shiftrightsu(64, 32, 10)}
...
object NV_soDLA_SDP_HLS_Y_int_mulDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_Y_int_mul)
}
