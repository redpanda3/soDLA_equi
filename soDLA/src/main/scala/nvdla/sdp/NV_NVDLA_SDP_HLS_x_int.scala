...
@chiselName
class NV_soDLA_SDP_HLS_x_int(throughtput: Int)(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_sdp_x_alu = Array.fill(throughtput){Module(new NV_soDLA_SDP_HLS_X_int_alu)}
    val u_sdp_x_mul = Array.fill(throughtput){Module(new NV_soDLA_SDP_HLS_X_int_mul)}
    val u_sdp_x_trt = Array.fill(throughtput){Module(new NV_soDLA_SDP_HLS_X_int_trt)}
    val u_sdp_x_relu = Array.fill(throughtput){Module(new NV_soDLA_SDP_HLS_X_int_relu)}
