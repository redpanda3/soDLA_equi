...
@chiselName
class NV_soDLA_SDP_HLS_lut_expn(LUT_DEPTH:Int = 256) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p2 = Module(new NV_soDLA_BC_pipe(42))
...
object NV_soDLA_SDP_HLS_lut_expnDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_lut_expn())
}