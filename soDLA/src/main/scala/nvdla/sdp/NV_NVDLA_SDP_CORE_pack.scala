...
@chiselName
class NV_soDLA_SDP_CORE_pack(IW: Int = 512, OW: Int = 128) extends Module {
   val RATIO = IW/OW
...
object NV_soDLA_SDP_CORE_packDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_CORE_pack())
}
