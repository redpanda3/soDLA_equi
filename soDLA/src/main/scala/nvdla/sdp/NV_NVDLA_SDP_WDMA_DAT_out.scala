...
@chiselName
class NV_soDLA_SDP_WDMA_DAT_out(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_SDP_WDMA_DAT_outDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_WDMA_DAT_out())
}
