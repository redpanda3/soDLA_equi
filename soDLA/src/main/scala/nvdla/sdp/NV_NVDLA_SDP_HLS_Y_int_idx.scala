...
@chiselName
class NV_soDLA_SDP_HLS_Y_int_idx extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module(new NV_soDLA_BC_pipe(32))
    ...
    val pipe_p2 = Module(new NV_soDLA_BC_pipe(32))
    ...
    val pipe_p3 = Module(new NV_soDLA_BC_pipe(32))
    ...
    val lut_le_expn = Module(new NV_soDLA_SDP_HLS_lut_expn(65))
    ...
    val lut_le_line = Module(new NV_soDLA_SDP_HLS_lut_line(65))
    ...
    val lut_lo_line = Module(new NV_soDLA_SDP_HLS_lut_line(257))
    ...
    val pipe_p4 = Module{new NV_soDLA_BC_pipe(81)}
...
object NV_soDLA_SDP_HLS_Y_int_idxDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_HLS_Y_int_idx)
}