...
@chiselName
class NV_soDLA_SDP_CORE_unpack(IW: Int = 128, OW: Int = 512) extends Module {
   val RATIO = OW/IW
...
object NV_soDLA_SDP_CORE_unpackDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_SDP_CORE_unpack())
}
