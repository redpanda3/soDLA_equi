...
@chiselName
class NV_soDLA_CACC_calculator(implicit conf: caccConfiguration) extends Module {
...
object NV_soDLA_CACC_calculatorDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_calculator())
}
