...
@chiselName
class NV_soDLA_CACC_assembly_buffer(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CACC_assembly_bufferDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_assembly_buffer())
}