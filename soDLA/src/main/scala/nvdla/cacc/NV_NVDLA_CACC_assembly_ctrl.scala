...
@chiselName
class NV_soDLA_CACC_assembly_ctrl(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CACC_assembly_ctrlDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_assembly_ctrl())
}
