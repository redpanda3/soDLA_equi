...
@chiselName
class NV_soDLA_CACC_calculator_for_check(implicit conf: caccConfiguration) extends Module {
    ...
    val io = IO(new Bundle {
        ...
        val dlv_data = Output(UInt(conf.CACC_DBUF_WIDTH.W))
