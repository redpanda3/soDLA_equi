...
@chiselName
class NV_soDLA_CACC_delivery_buffer_for_check(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CACC_delivery_buffer_for_checkDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_delivery_buffer_for_check())
}
