...
@chiselName
class NV_soDLA_cacc(implicit conf: nvdlaConfig) extends Module {
...
withReset(!io.nvdla_core_rstn){
    ...
    // Regfile
    //==========================================================
    val u_regfile = Module(new NV_soDLA_CACC_regfile)
    ...
    // Assembly controller
    //==========================================================
    val u_assembly_ctrl = Module(new NV_soDLA_CACC_assembly_ctrl)
    ...
    // Assembly buffer
    //==========================================================
    val u_assembly_buffer = Module(new NV_soDLA_CACC_assembly_buffer)
    ...
    // CACC calculator
    //==========================================================
    val u_calculator = Module(new NV_soDLA_CACC_calculator)
    ...
    // Delivery controller
    //==========================================================
    val u_delivery_ctrl = Module(new NV_soDLA_CACC_delivery_ctrl)
    ...
    val u_delivery_buffer = Module(new NV_soDLA_CACC_delivery_buffer)
...
object NV_soDLA_caccDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_cacc())
}
