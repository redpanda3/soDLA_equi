...
@chiselName
class NV_soDLA(implicit val conf: nvdlaConfig) extends Module {
...
//             └──┴──┘       └──┴──┘ 
    ...
    val u_partition_o = Module(new NV_soDLA_partition_o)
    val u_partition_c = Module(new NV_soDLA_partition_c)
    val u_partition_ma = Module(new NV_soDLA_partition_m)
    val u_partition_mb = Module(new NV_soDLA_partition_m)
    val u_partition_a = Module(new NV_soDLA_partition_a)
    val u_partition_p = Module(new NV_soDLA_partition_p)
    ////////////////////////////////////////////////////////////////////////
    //  NVDLA Partition O                                                 //
    ////////////////////////////////////////////////////////////////////////  
...
object NV_soDLADriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA())
}