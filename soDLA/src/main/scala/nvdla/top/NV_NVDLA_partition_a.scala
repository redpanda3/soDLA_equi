...
@chiselName
class NV_soDLA_partition_a(implicit val conf: nvdlaConfig) extends Module {
...
////////////////////////////////////////////////////////////////////////
    val u_partition_a_reset = Module(new NV_soDLA_reset)
...
//stepheng, modify for cacc verification
    val u_NV_soDLA_cacc = Module(new NV_soDLA_cacc)
    u_NV_soDLA_cacc.io.nvdla_clock.nvdla_core_clk := io.nvdla_core_clk
    u_NV_soDLA_cacc.io.nvdla_core_rstn := nvdla_core_rstn
    u_NV_soDLA_cacc.io.pwrbus_ram_pd := io.pwrbus_ram_pd

    io.cacc2glb_done_intr_pd := u_NV_soDLA_cacc.io.cacc2glb_done_intr_pd

    u_NV_soDLA_cacc.io.mac_a2accu <> io.mac_a2accu  
    u_NV_soDLA_cacc.io.mac_b2accu <> io.mac_b2accu 

    io.cacc2sdp_pd <> u_NV_soDLA_cacc.io.cacc2sdp_pd

    io.csb2cacc <> u_NV_soDLA_cacc.io.csb2cacc
    io.accu2sc_credit_size <> u_NV_soDLA_cacc.io.accu2sc_credit_size
    
    //Port for SLCG
    u_NV_soDLA_cacc.io.nvdla_clock.dla_clk_ovr_on_sync := dla_clk_ovr_on_sync
    u_NV_soDLA_cacc.io.nvdla_clock.global_clk_ovr_on_sync := global_clk_ovr_on_sync
    u_NV_soDLA_cacc.io.nvdla_clock.tmc2slcg_disable_clock_gating := io.tmc2slcg_disable_clock_gating


}


object NV_soDLA_partition_aDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_partition_a())
}
