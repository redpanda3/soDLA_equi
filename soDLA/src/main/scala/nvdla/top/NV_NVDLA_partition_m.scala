...
@chiselName
class NV_soDLA_partition_m(implicit val conf: nvdlaConfig) extends Module {
...
////////////////////////////////////////////////////////////////////////
    val u_partition_m_reset = Module(new NV_soDLA_reset)
...
////////////////////////////////////////////////////////////////////////
    val u_NV_soDLA_cmac = Module(new NV_soDLA_cmac)
    u_NV_soDLA_cmac.io.nvdla_clock.nvdla_core_clk := io.nvdla_core_clk
    u_NV_soDLA_cmac.io.nvdla_core_rstn := nvdla_core_rstn
    u_NV_soDLA_cmac.io.nvdla_clock.dla_clk_ovr_on_sync := dla_clk_ovr_on_sync
    u_NV_soDLA_cmac.io.nvdla_clock.global_clk_ovr_on_sync := global_clk_ovr_on_sync 
    u_NV_soDLA_cmac.io.nvdla_clock.tmc2slcg_disable_clock_gating := io.tmc2slcg_disable_clock_gating

    //csb
    io.csb2cmac_a <> u_NV_soDLA_cmac.io.csb2cmac_a
    
    //csc->cmac->cacc
    u_NV_soDLA_cmac.io.sc2mac_dat <> io.sc2mac_dat
    u_NV_soDLA_cmac.io.sc2mac_wt <> io.sc2mac_wt
    io.mac2accu <> u_NV_soDLA_cmac.io.mac2accu

}


object NV_soDLA_partition_mDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_partition_m())
}
