...
@chiselName
class NV_soDLA_csc(implicit val conf: nvdlaConfig) extends Module {
...
withReset(!io.nvdla_core_rstn){
    ...
    // Regfile
    //==========================================================
    val u_regfile = Module(new NV_soDLA_CSC_regfile)
    val u_sg = Module(new NV_soDLA_CSC_sg)
    ...
    // Weight loader
    //==========================================================
    val u_wl = Module(new NV_soDLA_CSC_wl)
    ...
    // Data loader
    //==========================================================
    val u_dl = Module(new NV_soDLA_CSC_dl)
...
object NV_soDLA_cscDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_csc())
}
