...
@chiselName
class NV_soDLA_CSC_regfile(implicit val conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_dual_reg_d0 = Module(new NV_soDLA_CSC_dual_reg)
    ...
    val u_dual_reg_d1 = Module(new NV_soDLA_CSC_dual_reg)
...
object NV_soDLA_CSC_regfileDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CSC_regfile())
}
