...
class NV_soDLA_CSC_dl(implicit val conf: nvdlaConfig) extends Module {
...
val rls_slices = RegInit("b0".asUInt(14.W))
val h_offset_slice = RegInit("b0".asUInt(14.W))
val entries = RegInit("b0".asUInt(conf.CSC_ENTRIES_NUM_WIDTH.W))
val entries_batch = RegInit(Fill("b0".asUInt(conf.CSC_ENTRIES_NUM_WIDTH.W))
val dataout_width_cmp = RegInit("b0".asUInt(13.W))
val pra_truncate = RegInit("b0".asUInt(8.W))
val rls_entries = RegInit(Fill("b0".asUInt(conf.CSC_ENTRIES_NUM_WIDTH.W))
val h_bias_0_stride = RegInit("b0".asUInt(12.W))
val h_bias_1_stride = RegInit("b0".asUInt(12.W))
val slice_left = RegInit("b0".asUInt(14.W))
...
val is_winograd_d1 = RegInit("b0".asUInt(22.W))
val is_img_d1 = RegInit("b0".asUInt(34.W))
val data_bank = RegInit("b0".asUInt(5.W))
val datain_width = RegInit("b0".asUInt(14.W))
val datain_width_cmp = RegInit("b0".asUInt(13.W))
val datain_height_cmp = RegInit("b0".asUInt(13.W))
val datain_channel_cmp = RegInit("b0".asUInt(13.W))
...
val conv_x_stride = RegInit("b0".asUInt(4.W))
val conv_y_stride = RegInit("b0".asUInt(4.W))
val pixel_x_stride_odd = RegInit(false.B) 
val batch_cmp = RegInit("b0".asUInt(5.W))
val pixel_x_init = RegInit("b0".asUInt(6.W))
val pixel_x_init_offset = RegInit("b0".asUInt(7.W))
val pixel_x_add = RegInit("b0".asUInt(7.W))
val pixel_x_byte_stride = RegInit("b0".asUInt(7.W))
val pixel_ch_stride = RegInit("b0".asUInt(12.W))
