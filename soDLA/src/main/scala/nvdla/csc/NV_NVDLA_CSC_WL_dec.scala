...
@chiselName
class NV_soDLA_CSC_WL_dec(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CSC_WL_decDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CSC_WL_dec)
}
