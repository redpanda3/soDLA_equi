...
@chiselName
class NV_soDLA_core_reset extends Module {
...
//             │ ─┤ ─┤       │ ─┤ ─┤         
//             └──┴──┘       └──┴──┘ 
    val sync_reset_synced_dla_rstn = Module(new SO_sync_reset)
    ...
    val sync_reset_synced_core_rstn = Module(new SO_sync_reset)
