...
@chiselName
class NV_soDLA_sync3d_s extends Module {
...
val UJ_dft_xclamp_ctrl_hold_sync_i = Module(new SO_BLKBOX_SRC0)
val dft_xclamp_hold_mux_s_sync_i = UJ_dft_xclamp_ctrl_hold_sync_i.io.Y

val UJ_dft_xclamp_scan_hold_sync_i = Module(new SO_BLKBOX_SRC0)
val dft_xclamp_hold_mux_i1_sync_i = UJ_dft_xclamp_scan_hold_sync_i.io.Y

val UJ_FP_MUX_sync_i_dft_xclamp_before_sync = Module(new SO_MUX2HDD2)
...
val sync_0 = Module(new SO_sync3d_s_ppp)
