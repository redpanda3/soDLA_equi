...
@chiselName
class NV_soDLA_PDP_RDMA_reg extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_dual_reg_d0 = Module(new NV_soDLA_PDP_RDMA_REG_dual)
    ...
    val u_dual_reg_d1 = Module(new NV_soDLA_PDP_RDMA_REG_dual)
...
object NV_soDLA_PDP_RDMA_regDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_PDP_RDMA_reg())
}
