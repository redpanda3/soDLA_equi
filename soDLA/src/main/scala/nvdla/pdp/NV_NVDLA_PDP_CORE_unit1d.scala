...
@chiselName
class NV_soDLA_PDP_CORE_unit1d(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_PDP_CORE_unit1dDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_PDP_CORE_unit1d())
}