...
@chiselName
class NV_soDLA_PDP_core(implicit val conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    //
    //--------------------------------------------------------------------
    val u_preproc = Module(new NV_soDLA_PDP_CORE_preproc)
    ...
    //
    //--------------------------------------------------------------------
    val u_cal1d = Module(new NV_soDLA_PDP_CORE_cal1d)
    ...
    //
    //--------------------------------------------------------------------
    val u_cal2d = Module(new NV_soDLA_PDP_CORE_cal2d)
...
object NV_soDLA_PDP_coreDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_PDP_core())
}