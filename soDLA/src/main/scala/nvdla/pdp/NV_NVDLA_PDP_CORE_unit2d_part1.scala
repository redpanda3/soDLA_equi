...
@chiselName
class NV_soDLA_PDP_CORE_CAL2D_pnum_flush(implicit val conf: nvdlaConfig) extends Module {
...
class NV_soDLA_PDP_CORE_CAL2D_pnum_updt(implicit val conf: nvdlaConfig) extends Module {
    val io = IO(new Bundle {
        //clk
        val nvdla_core_clk = Input(Clock())
...
class NV_soDLA_PDP_CORE_CAL2D_bubble_control_begin(implicit val conf: nvdlaConfig) extends Module {
    val io = IO(new Bundle {
        //clk
        val nvdla_core_clk = Input(Clock())
...
class NV_soDLA_PDP_CORE_CAL2D_mem_rd(implicit val conf: nvdlaConfig) extends Module {
    val io = IO(new Bundle {
        //clk
        val nvdla_core_clk = Input(Clock())
...
class NV_soDLA_PDP_CORE_CAL2D_rd_control_in_disable_time(implicit val conf: nvdlaConfig) extends Module {
    val io = IO(new Bundle {
        //clk
        val nvdla_core_clk = Input(Clock())
