...
@chiselName
class NV_soDLA_csb_master(implicit val conf: nvdlaConfig)  extends Module {
...
val u_fifo_csb2nvdla = Module(new NV_soDLA_CSB_MASTER_falcon2csb_fifo)
//clk&pwr_ram
...
val u_fifo_nvdla2csb = Module(new NV_soDLA_CSB_MASTER_csb2falcon_fifo)
//clk&pwr_ram
...
//////////////// for CFGROM ////////////////
val u_client_cfgrom = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00000000")}
...
//////////////// for GLB ////////////////
val u_client_glb = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00001000")}
...
//////////////// for MCIF ////////////////
val u_client_mcif = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00002000")}
...
//////////////// for CVIF ////////////////
val u_client_cvif = if(conf.NVDLA_SECONDARY_MEMIF_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h0000f000")}) else None
...
//////////////// for BDMA ////////////////
val u_client_bdma = if(conf.NVDLA_BDMA_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00010000")}) else None
...
//////////////// for CDMA ////////////////
val u_client_cdma = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00003000")}
...
//////////////// for CSC ////////////////
val u_client_csc = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00004000")}
...
//////////////// for CMAC_A ////////////////
val u_client_cmac_a = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00005000")}
...
//////////////// for CMAC_B ////////////////
val u_client_cmac_b = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00006000")}
...
//////////////// for CACC////////////////
val u_client_cacc = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00007000")}
...
//////////////// for SDP_RDMA////////////////
val u_client_sdp_rdma = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00008000")}
...
//////////////// for SDP ////////////////
val u_client_sdp = Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00009000")}
...
//////////////// for PDP_RDMA ////////////////
val u_client_pdp_rdma = if(conf.NVDLA_PDP_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h0000a000")}) else None
...
//////////////// for PDP ////////////////
val u_client_pdp = if(conf.NVDLA_PDP_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h0000b000")}) else None
if(conf.NVDLA_PDP_ENABLE){
...
//////////////// for CDP_RDMA ////////////////
val u_client_cdp_rdma = if(conf.NVDLA_CDP_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h0000c000")}) else None
...
//////////////// for CDP ////////////////
val u_client_cdp = if(conf.NVDLA_CDP_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h0000d000")}) else None
if(conf.NVDLA_CDP_ENABLE){
...
//////////////// for RUBIK ////////////////
val u_client_rubik = if(conf.NVDLA_RUBIK_ENABLE) Some(Module{new NV_soDLA_CSB_MASTER_for_client(address_space = "h00011000")}) else None
...
object NV_soDLA_csb_masterDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_csb_master())
}