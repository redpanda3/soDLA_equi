...
@chiselName
class NV_soDLA_CDMA_IMG_pack(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CDMA_IMG_packDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_IMG_pack())
}