...
@chiselName
class NV_soDLA_CDMA_img(implicit conf: nvdlaConfig) extends Module {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    val u_ctrl = Module(new NV_soDLA_CDMA_IMG_ctrl)
    ...
    val u_sg = Module(new NV_soDLA_CDMA_IMG_sg)
    ...
    val u_pack = Module(new NV_soDLA_CDMA_IMG_pack)
...
object NV_soDLA_CDMA_imgDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_img())
}
