...
@chiselName
class NV_soDLA_CDMA_regfile extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val u_single_reg = Module(new NV_soDLA_CDMA_single_reg)
    ...
    val u_dual_reg_d0 = Module(new NV_soDLA_CDMA_dual_reg)
    ...
    val u_dual_reg_d1 = Module(new NV_soDLA_CDMA_dual_reg)
...
object NV_soDLA_CDMA_regfileDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_regfile())
}
