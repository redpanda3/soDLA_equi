...
@chiselName
class NV_soDLA_CDMA_status(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CDMA_statusDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_status())
}
