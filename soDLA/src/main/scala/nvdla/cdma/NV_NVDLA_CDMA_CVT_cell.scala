...
@chiselName
class NV_soDLA_CDMA_CVT_cell(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module(new NV_soDLA_BC_pipe(18))
    ...
    val pipe_p2 = Module(new NV_soDLA_BC_pipe(34))
    ...
    //truncate
    val u_shiftright_su = Module(new NV_soDLA_HLS_shiftrightsu(34, 17, 6))
...
object NV_soDLA_CDMA_CVT_cellDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_CVT_cell())
}
