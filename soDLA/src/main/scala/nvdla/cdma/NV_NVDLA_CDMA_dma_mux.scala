...
@chiselName
class NV_soDLA_CDMA_dma_mux(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p1 = Module{new NV_soDLA_IS_pipe(conf.NVDLA_CDMA_MEM_RD_REQ)}
...
//////////////// MCIF interface ////////////////
    ...
    val pipe_p2 = Module{new NV_soDLA_IS_pipe(conf.NVDLA_CDMA_MEM_RD_REQ)}
...
////////////////////////////////////////////////////////////////////////
    ...
    val pipe_p3 = Module{new NV_soDLA_IS_pipe(conf.NVDLA_CDMA_MEM_RD_REQ)}
...
////////////////////////////////////////////////////////////////////////
    ...
    val pipe_p4 = Module{new NV_soDLA_IS_pipe(conf.NVDLA_CDMA_MEM_RD_REQ)}
...
object NV_soDLA_CDMA_dma_muxDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CDMA_dma_mux())
}
