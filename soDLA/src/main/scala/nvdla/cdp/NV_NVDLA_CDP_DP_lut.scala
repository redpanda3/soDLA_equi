...
@chiselName
class NV_soDLA_CDP_DP_lut(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CDP_DP_lutDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_lut())
}
