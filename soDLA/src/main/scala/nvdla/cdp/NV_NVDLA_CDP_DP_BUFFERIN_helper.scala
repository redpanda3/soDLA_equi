...
@chiselName
class NV_soDLA_CDP_DP_BUFFERIN_unpack(implicit val conf: nvdlaConfig) extends Module{
...
class NV_soDLA_CDP_DP_BUFFERIN_two_cycle_delay(implicit val conf: nvdlaConfig) extends Module{
    val io = IO(new Bundle {
        //clock
