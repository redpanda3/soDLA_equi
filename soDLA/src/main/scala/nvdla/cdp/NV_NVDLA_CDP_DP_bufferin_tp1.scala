...
@chiselName
class NV_soDLA_CDP_DP_bufferin_tp1(implicit val conf: nvdlaConfig) extends Module {
...
//assign buf_dat_rdy = buffer_ready;
    ...
    /////////////////////////////////////////
    val pipe_p1 = Module(new NV_soDLA_IS_pipe((conf.NVDLA_CDP_THROUGHPUT+8)*conf.NVDLA_CDP_ICVTO_BWPE+17))
...
object NV_soDLA_CDP_DP_bufferin_tp1Driver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_bufferin_tp1())
}
