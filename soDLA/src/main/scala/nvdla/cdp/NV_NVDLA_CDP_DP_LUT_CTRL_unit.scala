...
@chiselName
class NV_soDLA_CDP_DP_LUT_CTRL_unit(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CDP_DP_LUT_CTRL_unitDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig  
    chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_LUT_CTRL_unit())
}
