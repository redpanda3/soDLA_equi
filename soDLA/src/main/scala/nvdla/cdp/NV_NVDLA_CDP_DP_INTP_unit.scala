...
@chiselName
class NV_soDLA_CDP_DP_INTP_unit extends Module {
...
object NV_soDLA_CDP_DP_INTP_unitDriver extends App {
  chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_INTP_unit())
}
