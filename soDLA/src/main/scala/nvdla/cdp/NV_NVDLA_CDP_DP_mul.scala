...
@chiselName
class NV_soDLA_CDP_DP_mul(implicit val conf: nvdlaConfig) extends Module {
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    val pipe_p1 = Module(new NV_soDLA_IS_pipe(conf.NVDLA_CDP_THROUGHPUT*(conf.NVDLA_CDP_ICVTO_BWPE+16)))
    ...
    val u_mul_unit = Array.fill(conf.NVDLA_CDP_THROUGHPUT){Module(new NV_soDLA_MUL_unit(conf.NVDLA_CDP_ICVTO_BWPE, 16))}
...
object NV_soDLA_CDP_DP_mulDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_mul())
}
