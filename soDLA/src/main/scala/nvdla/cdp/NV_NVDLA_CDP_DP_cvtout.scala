...
@chiselName
class NV_soDLA_CDP_DP_cvtout(implicit val conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    ...
    val pipe_p0 = Module(new NV_soDLA_IS_pipe(17))
    ...
    val pipe_p1 = Module(new NV_soDLA_IS_pipe(17))
    ...
    val pipe_p2 = Module(new NV_soDLA_IS_pipe(17))
    ...
    val pipe_p3 = Module(new NV_soDLA_IS_pipe(17))
...
object NV_soDLA_CDP_DP_cvtoutDriver extends App {
    implicit val conf: nvdlaConfig = new nvdlaConfig
    chisel3.Driver.execute(args, () => new NV_soDLA_CDP_DP_cvtout())
}
