...
@chiselName
class NV_soDLA_CMAC_CORE_active(useRealClock:Boolean = false)(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CMAC_CORE_activeDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CMAC_CORE_active(useRealClock = true))
}
