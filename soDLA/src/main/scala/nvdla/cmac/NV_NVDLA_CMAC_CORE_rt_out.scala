...
@chiselName
class NV_soDLA_CMAC_CORE_rt_out(useRealClock:Boolean = false)(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CMAC_CORE_rt_outDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CMAC_CORE_rt_out(useRealClock = true))
}
