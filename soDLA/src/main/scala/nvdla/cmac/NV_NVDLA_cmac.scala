...
@chiselName
class NV_soDLA_cmac(implicit val conf: nvdlaConfig) extends Module {
...
withReset(!io.nvdla_core_rstn){
    ...
    // reg
    //==========================================================
    val u_core = Module(new NV_soDLA_CMAC_core)
    val u_reg = Module(new NV_soDLA_CMAC_reg)
    //clk
...
object NV_soDLA_cmacDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_cmac())
}
