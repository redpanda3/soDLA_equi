...
@chiselName
class NV_soDLA_CMAC_CORE_mac(useRealClock:Boolean = false)(implicit conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CMAC_CORE_macDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CMAC_CORE_mac(useRealClock = true))
}