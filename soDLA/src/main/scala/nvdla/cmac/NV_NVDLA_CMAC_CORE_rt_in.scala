...
@chiselName
class NV_soDLA_CMAC_CORE_rt_in(useRealClock:Boolean = false)(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CMAC_CORE_rt_inDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CMAC_CORE_rt_in(useRealClock = true))
}
