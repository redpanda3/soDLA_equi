...
@chiselName
class NV_soDLA_cbuf(useRealClock:Boolean = true)(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_cbufDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_cbuf(useRealClock = true))
}
